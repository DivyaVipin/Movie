package assignment.android.acadgild.movie;
...
import assignment.android.acadgild.adapter.DataAdapter;
import assignment.android.acadgild.models.DataHandler;
import assignment.android.acadgild.network.CallAddr;
import assignment.android.acadgild.network.NetworkStatus;
import assignment.android.acadgild.network.OnWebServiceResult;
...
public class MainActivity extends AppCompatActivity implements OnWebServiceResult {
    ...
    String url= "http://api.themoviedb.org/3/tv/top_rated?api_key=8496be0b2149805afa458ab8ec27560c";//It contains json data
    ...
    public void getWebResponse(String result, CommonUtilities.SERVICE_TYPE type) {
        ...
        try {
            ...
            for(int i=0; i<arr.length(); i++) {
               ...
               handler.setId(jobj.getString("id"));
                handler.setName(jobj.getString("name"));
                handler.setVote_count(jobj.getString("vote_count"));
                model.add(handler);
            }
